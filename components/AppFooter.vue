      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              <h5 class="widget-title">О компании</h5>
              <ul class="menu-list list-unstyled">
                ...
                <li class="menu-item">
                  <a href="#" class="nav-link">Наши дневники</a>
                </li>
                <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="#" class="nav-link">Пресса ультрас</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              <h5 class="widget-title">Обслуживание клиентов</h5>
              <ul class="menu-list list-unstyled">
                <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="#" class="nav-link">Возвраты & возмещения</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Обслуживание клиентов</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Информация о достовке</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6 copyright">
            <p>© 2025 DukonGO. Все права зашищены.</p>
          </div>
        </div>
      </div>
    </div>
